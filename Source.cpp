...
namespace Tmpl8
{
	Socket<CollisionMessage>* CollisionManager2::GetCollisionSocket()
	{
		return &m_collision_hub;
	}


	void CollisionManager2::PopulateLists()
	{
	...
	void CollisionManager2::RunCollisionCycle()
	{
		CheckSocketForNewCollisionMessages();
	...
	void CollisionManager2::CheckSocketForNewCollisionMessages()
	{
		...
		for (CollisionMessage& message : messages)
		{
			...
			case CollisionAction::UPDATE_ORB_LIST: // From glow manager.
				...
				break;
			case CollisionAction::DISABLE_PLAYER_COLLISIONS:// From game.
	...
	void CollisionManager2::UpdateList(CollisionMessage& collision_message, std::vector<Collidable*>& list_to_update)
	{
		list_to_update = collision_message.m_collidables;
	}


	void CollisionManager2::AddToList(CollisionMessage& collision_message, std::vector<Collidable*>& list_to_add_to)
	{
		list_to_add_to.push_back(collision_message.m_collidable);
	}


	void CollisionManager2::EnablePlayerCollisions(bool is_enabled)
	{
		m_is_player_collisions_enabled = is_enabled; // Game should tell player to ignore collisions instead.
	}


	void CollisionManager2::UpdateCollidables()
	{
	...
	void CollisionManager2::RebuildStaticList()
	{
	...
	void CollisionManager2::RebuildResolvableList()
	{
		// Credit to Kirill V. Lyadvinsky at https://stackoverflow.com/questions/3177241/what-is-the-best-way-to-concatenate-two-vectors
	...
	void CollisionManager2::RebuildCollidablesList()
	{
		// Credit to Kirill V. Lyadvinsky at https://stackoverflow.com/questions/3177241/what-is-the-best-way-to-concatenate-two-vectors
	...
	void CollisionManager2::CheckForCollisions()
	{
		/*
	...
	void CollisionManager2::SortCollidablesOnXAxis()
	{
	...
	std::vector<std::vector<Collidable*>> CollisionManager2::GetXAxisOverlaps(std::vector<Collidable*>& collidables)
	{
		/*
	...
	std::vector<std::vector<Collidable*>> CollisionManager2::GetYAxisOverlaps(std::vector<std::vector<Collidable*>>& x_overlaps)
	{
		/*
	...
	void CollisionManager2::NotifyCollisionPairs()
	{
	...
	void CollisionManager2::ResolveCollisions()
	{	
