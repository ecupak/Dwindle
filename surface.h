...
public:
	...
	void CopyFrom(Surface* a_Src, int src_start_X, int src_start_Y, int width, int height);
...
public:
	...
	// Structors
	Sprite( Surface* a_Surface, unsigned int a_NumFrames, bool isOwnerOfSurface );
	~Sprite();
	// Methods
